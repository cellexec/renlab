...
Read the codebase first to understand the existing patterns, then implement all the changes described in the spec. If the spec includes a "Project Context" section, follow those conventions strictly.
${knowledgeContext ? `\n<project-knowledge>\n${knowledgeContext}\n</project-knowledge>\n` : ""}
<specification>
${specContent}
</specification>
